...
import com.handle.law.pulltorefresh.library.internal.EmptyViewMethodAccessor;
import com.handle.law.pulltorefresh.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public final void setSelection(int _scrollTop) {
		mRefreshableView.setSelection(_scrollTop);
	}
	
	public final void setTranscriptMode(int _mode) {
		mRefreshableView.setTranscriptMode(_mode);
	}
	
	public final int getTranscriptMode() {
		return mRefreshableView.getTranscriptMode();
	}
	
	public final void setScrollingCacheEnabled(boolean _bool) {
		mRefreshableView.setScrollingCacheEnabled(_bool);
	}
