 ...
 *******************************************************************************/
package com.handle.law.pulltorefresh.library;
...
import com.handle.law.pulltorefresh.library.internal.FlipLoadingLayout;
import com.handle.law.pulltorefresh.library.internal.LoadingLayout;
import com.handle.law.pulltorefresh.library.internal.RotateLoadingLayout;
import com.handle.law.pulltorefresh.library.internal.Utils;
import com.handle.law.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void setOnHeaderPullingListener(HeaderPullingListener listener){
		headerPullingListener = listener;
	}
	...
	protected final void setHeaderScroll(int value) {
		...
		if(headerPullingListener != null ){
			final int orientation = getPullToRefreshScrollDirection() == Orientation.VERTICAL
					...
					: HeaderPullingListener.PULLING_ORIENTATION_VERTICAL;
			headerPullingListener.onHeaderPulling(orientation,value);
		}
	...
	public void setSelectionFromTop (int position, int y) {
		((ListView) mRefreshableView).setSelectionFromTop(position, y);
	}

	public void addHeadView(View headView) {
		((ListView) mRefreshableView).addHeaderView(headView);
	}
	
	public void addFootView(View footView) {
		((ListView) mRefreshableView).addFooterView(footView);
	}
	
	public void removeHeadView(View headView) {
		((ListView) mRefreshableView).removeHeaderView(headView);
	}
	
	public void removeFootView(View footView) {
		((ListView) mRefreshableView).removeFooterView(footView);
	}
}
