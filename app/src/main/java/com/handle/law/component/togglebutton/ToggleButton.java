package com.handle.law.component.togglebutton;
...
public class ToggleButton extends View{
	...
	/** 开启颜色*/
	private int onColor = Color.parseColor("#FF8800");
	/** 关闭颜色*/
	private int offBorderColor = Color.parseColor("#CCCCCC");
	/** 灰色带颜色*/
	private int offColor = Color.parseColor("#CCCCCC");
	/** 手柄颜色*/
	...
	public void setup(AttributeSet attrs) {
		...
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_borderWidths, borderWidth);
